...
- [仕様メモ](./仕様メモ.md)
  - 入力、出力、本戦専用モード、品質評価の要点をまとめて確認したいとき
...
- [分析3ドメイン直列化構想](./分析3ドメイン直列化構想.md)
  - `分析` をシミュレーション域、最終順位付け域、大会品質評価域へ分ける将来像を確認したいとき

## 説明書一覧

### ルールを知る
- [仕様メモ](./仕様メモ.md)
  - プロジェクト全体の目的、前提ルール、入力、出力、品質評価の要点
...
- [分析3ドメイン直列化構想](./分析3ドメイン直列化構想.md)
  - `ApplicationWorkflow.Run` 直下は大会利用者域と分析に保ち、分析の内側を3ドメインへ分ける方針
