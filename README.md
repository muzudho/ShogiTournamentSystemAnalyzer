...
このプロジェクトの［コーディング］だけでなく、［実験］や［新しいルール］の追加も、GPT-5.4 にやってもらうことを想定しています。  
このプロジェクトは、 GPT-5.4 に与える思考のフレームワークと考えてください。  
わたし（人間；むずでょ）は、思考のフレームワークを整える、まるで、庭の草むしりだけするかのようなことをしています。  

また、プログラミング界隈での古来からの［他人にコピーされるプログラムが良いプログラムだ］という品質評価方法に則り、どなた（人間、ＡＩ）でも使っていただけるよう、オープンソース（MIT ライセンス）で公開しています。  
